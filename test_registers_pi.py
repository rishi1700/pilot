...
REGISTERS = [
    ...
    (0x42, "OOP",             "RW",   0x0000,   "Output optical power (live)"),
    (0x43, "CTemp",           "RW",   0x0019,   "Chip temperature (°C, signed)"),
    (0x4F, "FTFR_MHz",        "RO",   None,     "Fine tune frequency range (MHz)"),
    (0x50, "OPSL",            "RO",   None,     "Min optical power (0.01 dBm)"),
    (0x51, "OPSH",            "RO",   None,     "Max optical power (0.01 dBm)"),
    (0x52, "LFL1",            "RO",   None,     "First channel freq – THz"),
    (0x53, "LFL2",            "RO",   None,     "First channel freq – GHz×10"),
    (0x54, "LASTF1",          "RO",   None,     "Last channel freq – THz"),
    (0x55, "LASTF2",          "RO",   None,     "Last channel freq – GHz×10"),
