...
REGISTERS = [
    ...
    (0x58, "Temps",           "AEA",  None,     "9.8.2: Diode and case temperatures (°C×100) via AEA"),
    (0x59, "DitherCtrl",      "RW",   0x0000,   "9.8.3: Dither ctrl – bits[5:4]=waveform, bit[1]=enable (0=off)"),
    (0x5A, "DitherRate",      "RW",   0x0064,   "9.8.3: Dither rate (valid 10–200, default 100)"),
    (0x5B, "DitherFreq",      "RW",   0x0000,   "9.8.3: Dither frequency"),
    (0x5C, "DitherAmp",       "RW",   0x0000,   "9.8.3: Dither amplitude (0–1000)"),
    (0x5D, "TBTFL",           "RW",   0xFE0C,   "9.8.4: Thermal boundary low limit (°C×100, signed; default −500 = 0xFE0C)"),
    (0x5E, "TBTFH",           "RW",   0x1B58,   "9.8.4: Thermal boundary high limit (°C×100, signed; default 7000 = 0x1B58)"),
    (0x5F, "FAgeTh",          "RW",   0x0000,   "9.8.6: Fatal age threshold (%EOL, 0=disabled)"),
    (0x60, "WAgeTh",          "RW",   0x0000,   "9.8.6: Warning age threshold (%EOL, 0=disabled)"),
    (0x61, "Age",             "RO",   None,     "9.8.6: Module age (%EOL, read-only)"),
